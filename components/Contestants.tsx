...
const Contestants: React.FC<{ contestants: ContestantStruct[]; poll: PollStruct }> = ({
  ...
  return (
    <div className="space-y-2">
      <h1 className="text-center text-[#34C759] text-[48px] font-[600px]">Contestants</h1>
...
const Contestant: React.FC<{ contestant: ContestantStruct; poll: PollStruct }> = ({
  ...
  return (
    <div className="flex justify-start items-center space-x-2 md:space-x-8 mt-5 md:mx-auto">
      ...
      <div
        className="bg-[#151515] bg-opacity-60 h-[229px] w-[186px] sm:w-[253px] sm:h-fit rounded-[24px]
      ...
      >
        ...
        >
          {wallet && contestant.voters.includes(wallet) ? 'Voted' : 'Vote'} {/* VOTE COUNT HERE */}
        </button>
