...
const Details: React.FC<{ poll: PollStruct }> = ({ poll }) => {
  ...
  return (
    <>
      ...
      >
        <h1 className="text-[47px] text-[#34C759] font-[600px] text-center leading-none">{poll.title}</h1>
        <p className="text-[26px] text-[#34C759] font-[500px] text-center">{poll.description}</p>
        ...
        <div className=" h-[136px] gap-[16px] flex flex-col items-center mt-4">
          <div
            ...
            border-gray-400 bg-[#34C759] bg-opacity-20"
          >
          ...
          <div className="h-[36px] gap-[4px] flex justify-center items-center">
            <button
              className="py-[6px] px-[12px] border border-gray-400 bg-[#34C759] bg-opacity-20
            ...
            <button
              ...
              border border-gray-400 bg-[#34C759] bg-opacity-20 rounded-full text-[12px] md:text-[16px]"
            >
            ...
            {wallet && wallet === poll.director && poll.votes < 1 && (
              <button
                className="py-[6px] px-[12px] 
              border border-gray-400 bg-[#34C759] bg-opacity-50 rounded-full 
          ...
          {poll.votes < 1 && (
            <button
              ...
              border border-gray-400 bg-[#1B5CFE] hover:bg-green-500 hover:text-white py-2"
