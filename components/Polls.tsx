...
const Polls: React.FC<{ polls: PollStruct[] }> = ({ polls }) => {
  return (
    <div>
      <h1 className="text-center text-[#34C759] text-[34px] font-[50px] mb-5">Current Polls</h1>
      ...
      >
        ...
        <div
          className="w-full h-[257px] gap-[14px] rounded-[24px] space-y-5
                md:w-[352px] md:h-[280px] bg-[#151515] bg-opacity-40 px-[15px] py-[18px] md:px-[22px]"
        >
          ...
          <button
            ...
            className="h-[44px] w-full rounded-full transition-all duration-300 bg-[#1B5CFE] hover:bg-green-500"
          >
            Enter Poll
          </button>
        </div>
